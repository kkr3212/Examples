...
namespace GameClient
{
    public partial class FormPvE : Form
    {
        ...
        public void OnViewEntered()
        {
            ...
            NetworkAPI.Requester.UserData_InvenCharacter((response) =>
            {
                ...
                NetworkAPI.Requester.PvE_GetDeck(DeckType.PvE_Normal, (responseDeck) =>
                {
                    ...
                    NetworkAPI.Requester.PvE_WorldList(OnRecv_WorldList);
                });
            });
        }
        ...
        private void OnSelected_World(object sender, EventArgs e)
        {
            ...
            NetworkAPI.Requester.PvE_FieldList(worldId, (response) =>
            {
                _lvField.Items.Clear();
                _lvDungeon.Items.Clear();
        ...
        private void OnSelected_Field(object sender, EventArgs e)
        {
            ...
            NetworkAPI.Requester.PvE_DungeonList(fieldId, (response) =>
            {
                _lvDungeon.Items.Clear();

...
namespace GameClient
{
    public partial class FormGameMain : Form
    {
        ...
        public void OnViewEntered()
        {
            ...
            NetworkAPI.Requester.GameData_Codes(OnRecv_GameData_Code);
        }
        ...
        {
            NetworkAPI.Requester.UserData_UserInfo(OnRecv_UserInfo);
        }
        ...
        private void OnRecv_GameData_Code(Response_GameData_Codes response)
        {
            ...
            NetworkAPI.Requester.GameData_CharacterBook(0, OnRecv_CharacterBook);
        }
        ...
        private void OnRecv_CharacterBook(Response_CharacterBook response)
        {
            if (response.Items.Count == 0)
            {
                ...
                NetworkAPI.Requester.GameData_MonsterBook(0, OnRecv_MonsterBook);
                return;
            }
            ...
            NetworkAPI.Requester.GameData_CharacterBook(lastId + 1, OnRecv_CharacterBook);
        }
        ...
        private void OnRecv_MonsterBook(Response_MonsterBook response)
        {
            ...
            NetworkAPI.Requester.GameData_MonsterBook(lastId + 1, OnRecv_MonsterBook);
        }
